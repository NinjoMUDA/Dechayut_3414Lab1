...
Server tests:
 ...
 ✓ tests/lab-01/categories.test.ts (1 test) 51ms
 ✓ tests/lab-02/dev-requester.api.test.ts (3 tests) 70ms
 ✓ tests/lab-02/create-ticket.api.test.ts (3 tests) 129ms
 ✓ tests/lab-02/my-tickets.api.test.ts (5 tests) 249ms
 Test Files  5 passed (5)
      Tests  13 passed (13)

Client tests:
 ✓ tests/lab-01/App.test.tsx (3 tests) 242ms
 ✓ tests/lab-02/RequesterSelector.test.tsx (3 tests) 175ms
 ✓ tests/lab-02/CreateTicket.test.tsx (4 tests) 285ms
 ✓ tests/lab-02/MyTickets.test.tsx (5 tests) 259ms
