...
- **Reviewer GitHub Username:** vienggg
- **PR Author:** Dechayut (NinjoMUDA)
...
| PR #23 | `feature/3-my-tickets` | Feature: My Tickets View, Search & Filtering | Ready for PR | Pending Review | Implemented `GET /api/tickets` with requester isolation, multi-filter search, sorting, pagination, and Zen Green MyTickets UI. |
...
### PR #20 (Docs: Lab 2 Engineering Contract & Specifications)
- **Reviewer:** vienggg
...
### PR #22 (Feature: Create Ticket Flow & Form Validation)
- **Reviewer:** vienggg
- **Comment:** "cool man!"
- **Comment:** "merged!"
- **Status:** Approved and Merged into `lab2-staging`.
