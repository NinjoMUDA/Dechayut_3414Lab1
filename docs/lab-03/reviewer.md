...
| [PR #36](https://github.com/NinjoMUDA/Dechayut_3414Lab1/pull/36) | [Issue #30](https://github.com/NinjoMUDA/Dechayut_3414Lab1/issues/30) | `feature/30-ticket-operations` | Feature: IT Staff Ticket Operations & Notes | Open | Pending | Claim/reassign ownership, IT priority, BR-14 status transitions, public comments, and confidential internal notes. |
