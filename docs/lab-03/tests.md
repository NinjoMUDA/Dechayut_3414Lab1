...
| API-14 | API | AC-07, FR-07, BR-04 | Create and retrieve Public Comments | 201 Created & 200 OK; visible to Requester, Staff, and Admin | `server/tests/lab-03/comments-notes.api.test.ts` | Planned |
| API-15 | API | FR-13, BR-05 | IT Staff posts and retrieves Internal Notes | 201 Created & 200 OK; persisted and visible to Staff/Admin | `server/tests/lab-03/comments-notes.api.test.ts` | Planned |
